import {
  ...
  export function Dressstyle() {
    return (
      <div className="p-5">
       <div className="flex justify-between items-center"> <h1 className="font-bold">Dress Styles</h1>
       <LuFilter/>
       </div>
    ...
    <div className="flex justify-center items-center">
        ...
        <button className="border rounded-2xl bg-black text-white w-[100%] h-[35px] mt-4"> Apply Filter </button>
    </div>
